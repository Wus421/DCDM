...
from utils.evaluations import eval_bond_length_config
...
def get_distribution(distances: Sequence[float], bins=eval_bond_length_config.DISTANCE_BINS) -> np.ndarray:
    ...
    Returns:
        np.array: empirical distribution of distances with length equals to DISTANCE_BINS.距离随长度的经验分布等于DISTANCE_BINS。
    """
