...
class PocketLigandPairDataset(Dataset):
    ...
    def __init__(self, raw_path, transform=None, version='final'):
        ...
        self.processed_path = os.path.join(os.path.dirname(self.raw_path),
                                           os.path.basename(self.raw_path) + f'_processed_new_vina{version}.lmdb')
        self.molid2idx_path = self.processed_path[:self.processed_path.find('.lmdb')]+'_molid2idx_new_vina.pt'
