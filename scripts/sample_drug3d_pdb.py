...
def pdb_to_pocket_data(pdb_path):
    ...
    data = ProteinLigandData.from_protein_ligand_dicts(
        ...
        ligand_dict={
            ...
            'filename': '/home/wus/MolDiff-targetdiff/data/testdata2/5t6n_Z_75U.sdf'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pdb_path', type=str, default='/home/wus/MolDiff-targetdiff/data/testdata2/5t6n_Y_75U_pocket10.pdb')
