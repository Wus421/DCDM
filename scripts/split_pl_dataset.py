...
from pldatasets.pl_pair_dataset import PocketLigandPairDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='/home/wus/targetdiff/data/dataa/crossdocked_v1.1_rmsd1.0_pocket10')
    parser.add_argument('--dest', type=str, default='/home/wus/targetdiff/data/dataa/crossdocked_pocket10_pose_split_new_vinafenlei.pt')
    parser.add_argument('--fixed_split', type=str, default='/home/wus/targetdiff/data/dataa/split_by_name.pt')
